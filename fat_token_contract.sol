...
contract FAToken {
    ...
    constructor()
        public
    {
        ownerBalance[msg.sender] = _totalSupply;
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        require(ownerBalance[_from] >= _value, "Insufficient balance");
        ownerBalance[_from] = ownerBalance[_from].sub(_value);
        ownerBalance[_to] = ownerBalance[_to].add(_value);
